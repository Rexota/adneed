 ...
 $(function(){
   ...
   $('#site_eklebutton2').click(function() {
	...
	$.post('inc_yayinci/sitelerim.php?mode=yontem', {yontem : yontem}, function(response) {
		...
		<td height="35" width="464">&nbsp;<select id="yontem" name="yontem" class="select"><option value="0">Otomatik</option><option value="1">Header'e kod koyarak</option><option value="2">FTP'de dosya oluşturarak</option></select></td>
				</tr>
				<tr>
...
hepsinikapat();
 ...
 $(function(){
    ...
    $('#otomatik_onay').click(function() {
  
    var salla = $('#salla').val();
    
	$.post('inc_yayinci/sitelerim.php?mode=otomatik', { salla : salla}, function(response) {
  ...
  $('#ftp_onay').click(function() {
	...
	$.post('inc_yayinci/sitelerim.php?mode=ftp', { salla : salla}, function(response) {
		...
		<? if ($_SESSION['siteyontem']=="0") { ?>
		
				<tr>
		<td height="35" width="164">&nbsp;Onaylama Yönetmi:</td>
		<td height="35" width="464">&nbsp;Otomatik</td>
				</tr>

				<tr>
	    <input type="hidden" id="salla" name="salla" value="<?=$_SESSION['code']?>">
		<td height="35" width="164">&nbsp;Bilgi:</td>
		<td height="35" width="464">&nbsp;<font style="font-size:13px;">Aşağıdaki butona tıkladığınızda otomatik olarak onaylanacaktır.</font></td>
				</tr>
				<tr>
		<td height="35" width="164">&nbsp;İşlem</td>
		<td height="35" width="234" align="left">&nbsp;<input type="button" id="otomatik_onay" class="button" value="Onayla"> <input onclick="document.getElementById('site_ekle_panel3').style.display='none';" type="button" class="button" value="Vazgeç"></td>
					</tr>
					<tr>
