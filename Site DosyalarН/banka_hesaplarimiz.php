...
<script type="text/javascript">
 ...
 function bankasil(id) {
 	...
 	$.post('inc_admin/hesap.php?mode=sil', {id: id}, function(response) {
 ...
 $('#banka_hesaplarim').load('inc_admin/hesap.php?mode=see');
...
hesapyenile();
  ...
  $('#hesap_eklebutton2').click(function() {
	...
	$.post('inc_admin/hesap.php?mode=ekle', {banka : banka_adi, sube : sube_kodu, iban : iban, ad : ad, hesap : hesapno}, function(response) {
...
<table id="hesap_ekle_panel" style="display:none;" border="0" width="920" cellpadding="0">
	...
	<tr>
		...
		<td height="35" width="234" align="left">&nbsp;<input type="button" id="hesap_eklebutton2" class="button" value="Ekle"> <input onclick="$('#hesap_ekle_panel').slideUp();" type="button" class="button" value="Vazgeç"></td>
					</tr>
					<tr>
