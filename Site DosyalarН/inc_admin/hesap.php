...
<title></title>
<?	
$result = @mysql_query("select * from hesaplarimiz");
...
?>
 <table border="0" width="920" cellpadding="0" style="border-collapse: collapse">
			...
			Eklenmiş banka hesabı bulunamadı.</td>
		</tr>
		</table>
...
$del = mysql_query("delete from hesaplarimiz where id = '$id'");
...
$yali = "insert into hesaplarimiz (banka,hesapno,sube,iban,ad) values ('$banka', '$hesap', '$sube', '$iban','$ads')";
