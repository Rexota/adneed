...
$aysip = $_COOKIE["popup_click_user_ip"];

if ($aysip=='') {
$ip = GetIP();
setcookie("popup_click_user_ip",$ip, time()+$havuz);
} else { 
$ip = $_COOKIE["popup_click_user_ip"];
}


$dosya = "cache_pop/".$reklam_benzersiz.".txt";
$icerik = @file($dosya);
...
$dosyam = "click_pop/".$reklam_benzersiz.".txt";
