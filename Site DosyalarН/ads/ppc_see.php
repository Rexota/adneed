...
$kst1 = explode("[kesinti]", $buldum);
$kst2 = explode("[/b]", $kst1[1]);
$reklam_kesinti = $kst2[0];

$rtk1 = explode("[tikbas]", $buldum);
$rtk2 = explode("[/b]", $rtk1[1]);
$reklam_tikbas = $rtk2[0];


$net_tutar = $reklam_tikbas - $reklam_kesinti;
$net_tutar = str_replace("," , "" , $net_tutar);
...
$sor = @mysql_num_rows(mysql_query("select * from ppc_sayimlar where gun = '$gun' and ay = '$ay' and yil = '$yil' and yayinci_kimlik = '$yayinci_kimlik' and  site_id = '$site_id'"));
if ($sor < 1) { $yali = @mysql_query("insert into ppc_sayimlar (yayinci_kimlik, sayi, gun, ay, yil , ucret, alacak, site_id, yayinci_id, tarih, site_adresi, tarih2 ) values ('$yayinci_kimlik', '0', '$gun', '$ay', '$yil', '0', '0', '$site_id', '$yayinci_id', '$tarih1', '$site_adresi', '$tarih2')");  }
}
...
$puanver = @mysql_query("UPDATE ppc_sayimlar SET sayi = sayi+1, alacak = alacak + $net_tutar where gun = '$gun' and ay = '$ay' and yil = '$yil' and site_id = '$site_id' and yayinci_kimlik = '$yayinci_kimlik'");
...
$guncelle1 = @mysql_query("UPDATE ppc_reklamlar SET suan = suan+1, bugun = bugun+1 where id = '$reklam_id'") or die(mysql_error());
