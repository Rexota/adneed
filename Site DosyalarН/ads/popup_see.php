...
$sor = @mysql_num_rows(mysql_query("select * from popup_sayimlar where gun = '$gun' and ay = '$ay' and yil = '$yil' and yayinci_kimlik = '$yayinci_kimlik' and  site_id = '$site_id'"));
if ($sor < 1) { $yali = @mysql_query("insert into popup_sayimlar (yayinci_kimlik, sayi, gun, ay, yil , ucret, alacak, site_id, yayinci_id, tarih, site_adresi, tarih2 ) values ('$yayinci_kimlik', '0', '$gun', '$ay', '$yil', '$ucret', '0', '$site_id', '$yayinci_id', '$tarih1', '$site_adresi', '$tarih2')");   }
}


$puanver = @mysql_query("UPDATE popup_sayimlar SET sayi = sayi+1 where gun = '$gun' and ay = '$ay' and yil = '$yil' and site_id = '$site_id' and yayinci_kimlik = '$yayinci_kimlik'");
...
$guncelle1 = @mysql_query("UPDATE popup_reklamlar SET suan = suan+1, bugun = bugun+1 where id = '$reklam_id'");
