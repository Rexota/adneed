...
$aysip = $_COOKIE["msn_click_user_ip"];

if ($aysip=='') {
$ip = GetIP();
setcookie("msn_click_user_ip",$ip, time()+$havuz);
} else { 
$ip = $_COOKIE["msn_click_user_ip"];
}


$dosya = "cache_msn/".$reklam_benzersiz.".txt";
$icerik = @file($dosya);
...
$dosyam = "click_msn/".$reklam_benzersiz.".txt";
